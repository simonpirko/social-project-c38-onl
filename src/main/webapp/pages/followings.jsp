            ...
            <c:choose>
                    ...
                    <ul class="list-group list-group-flush rounded-4">
                        <c:forEach var="following" items="${followings}">
                            <li class="list-group-item d-flex align-items-center justify-content-between p-3">
                                ...
                                <div>
                                    <a href="/account?id=${following.id}" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                                        Профиль
                                    </a>
                                </div>
                            </li>
                ...
                <c:otherwise>
                    <div class="text-center py-5">
                        <p class="mt-3 text-secondary fs-5">Пока нет подписок</p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
