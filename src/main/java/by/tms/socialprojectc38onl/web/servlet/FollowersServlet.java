...
public class FollowersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Account> followers = subscribeService.findAllFollowers(showingAccountId);
        req.setAttribute("followers", followers);
        req.getRequestDispatcher("/pages/followers.jsp").forward(req, resp);
    }
}
